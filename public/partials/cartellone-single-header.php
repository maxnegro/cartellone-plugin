...
<article id="post-<?php echo esc_attr( $post_id ); ?>" class="post-<?php echo esc_attr( $post_id ); ?> <?php echo esc_attr( $post_classes ); ?>">
	<header class="entry-header">
		...
		<div class="post-img-wrap">
			...
			<?php else : ?>
				<img src="<?php echo esc_url( apply_filters( 'cartellone_placeholder_image_url', CARTELLONE_URL . 'public/img/teatro-bibiena-placeholder.png' ) ); ?>" alt="<?php echo esc_attr( get_the_title( $post_id ) ); ?>" style="width: 100%; display: block;">
			<?php endif; ?>
